...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MegaSynth Demo Installer\n"
      else:
        line="OutputBaseFilename=MegaSynth Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MegaSynth Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MegaSynth installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MegaSynth Demo installer\n"
     else:
       line="SetupWindowTitle=MegaSynth installer\n"
